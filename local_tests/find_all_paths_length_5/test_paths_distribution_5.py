...
def main():
    ...
    SUMMARY_LOG = os.path.join(LOG_DIR, "summary_paths_different_distributions_5.log")

    summary_logger = logging.getLogger("summary_paths_different_distributions_5")
    ...
    for color_distribution in ['uniform', 'average', 'rare']:
        for graph_avg_neighs in [8, 10, 13, 15]:
            ...
            summary_logger.info(f"g_den_{graph_avg_neighs}_embedded_den_5_{color_distribution} | AVERAGE path_only={avg_false_positives}")
