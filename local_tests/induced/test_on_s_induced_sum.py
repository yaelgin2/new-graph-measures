...
def main():
    ...
    TIMES_LOG   = os.path.join(COMPARE_LOG_DIR, "equal_degs_times_induced_motifs.log")
    ...
    times_logger = logging.getLogger("equal_degs_times_induced_motifs")
    ...
    for graph_avg_neighs in [5]:
        for color_distribution in ["uniform", "average", "rare"]:
            ...
            logger = logging.getLogger(f"induced_{run_name}")
            ...
            g_motifs = compute_motifs(os.path.join(INPUT_DIR, "G_induced.json"))
