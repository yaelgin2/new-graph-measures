...
def main():
    ...
    LOG_FILE = os.path.join(LOG_DIR, f"max_number_of_edges_in_negatory_motif_8.log")
    ...
    for color_distribution in ['uniform', 'average', 'rare']:
        for graph_avg_neighs in [10, 13, 15]:
            
            INPUT_DIR = os.path.join(BASE_DIR, "local_tests", f"input_color_{color_distribution}_deg_8")
